...
-- Create a table that stores first-touch attribution per visitor
-- Using AggregatingMergeTree to automatically maintain argMin aggregations
...
-- +goose StatementBegin
-- Materialized view to keep first-touch attribution updated
...
-- +goose StatementBegin
-- Materialized view for revenue timeline (hourly buckets)
-- This speeds up queries for "revenue timeline" endpoint
...
-- +goose StatementBegin
-- Materialized view for revenue timeline (daily buckets)
