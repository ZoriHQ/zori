...
type ClientEventV1 struct {
	...
	// Identity fields (optional - set when visitor is identified)
	UserID     *string `json:"user_id"`     // Authenticated user ID
	ExternalID *string `json:"external_id"` // Customer-provided external identifier
	Email      *string `json:"email"`       // Email address (will be hashed for storage)
